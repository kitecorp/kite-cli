...
KITE_VERSION=1.0.0 curl -fsSL https://install.kitelang.cloud/kite-cli/scripts/install.sh | bash

# Skip PATH modification
KITE_NO_MODIFY_PATH=1 curl -fsSL https://install.kitelang.cloud/kite-cli/scripts/install.sh | bash
```
